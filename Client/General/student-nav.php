...
<div>
    <ul class="ui-nav-ul">
        ...
        <li class="ui-nav-left"><a class="ui-nav-li-a ui-nav-left <?PHP echo $isNextActive; ?>" href="../Student/next-question.php">Next question</a></li>
        <li class="ui-nav-left"><a class="ui-nav-li-a ui-nav-left <?PHP echo $isReviewActive; ?>" href="../Student/view-old-question.php">Review</a></li>
